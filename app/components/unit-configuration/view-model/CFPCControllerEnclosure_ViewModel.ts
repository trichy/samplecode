...
export class CFPCControllerEnclosure_ViewModel implements IRenderable {
    constructor(
        private _unit: CUnit_ViewModel,
        private _model: ModelInterfacesAHU.Configuration.Types.IFPCControllerEnclosure) {
    }
    ...
    public get model(): ModelInterfacesAHU.Configuration.Types.IFPCControllerEnclosure {
        return this._model;
    }
    ...
    render() {
        ...
        if (this.model.unitSide === EnumsCommon.Common.E_UnitSide.Front) {
            ...
            this._exteriorMaterial_Rest_Front = PolygonGenerator.CUtility.getLabelMaterial(
                this.model.userDefinedName ? this.model.userDefinedName : "FPC",
                "#fa9225",
                "white",
                this.model.geometry.zLength,
                this.model.geometry.yLength);
    ...
    click(evt: Event) {
        ...
        if (this.isSelected) {
            CFPCControllerEnclosure_Selected.addToList(this.model, this);
            CFPCControllerEnclosure_Selected.setselectedItem(this.model.id, this.isSelected);
