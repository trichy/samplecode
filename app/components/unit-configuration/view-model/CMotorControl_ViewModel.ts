...
export class CMotorControl_ViewModel implements IRenderable 
{
    constructor(
        private _unit: CUnit_ViewModel,
        private _model: ModelInterfacesAHU.Configuration.Types.IMotorControl) 
    {
    ...
    public get model(): ModelInterfacesAHU.Configuration.Types.IMotorControl {
        return this._model;
    }
    ...
    render() {
        ...
        if (this.model.unitSide === EnumsCommon.Common.E_UnitSide.Front) {
            ...
            this._exteriorMaterial_Rest_Front = PolygonGenerator.CUtility.getLabelMaterial(
                this.model.userDefinedName ? this.model.userDefinedName :
                    (this._descriptorStoreAHU.MotorControl.MotorControlType.uiDescription(this.model.motorControlType) ?
                        this._descriptorStoreAHU.MotorControl.MotorControlType.uiDescription(this.model.motorControlType) :
                        "Motor Control"),
                "#fa9225",
                "white",
        ...
        if (this.model.unitSide === EnumsCommon.Common.E_UnitSide.Top) {
            ...
            this._exteriorMaterial_Selected_Bottom = PolygonGenerator.CUtility.getLabelMaterial(
                this.model.userDefinedName ? this.model.userDefinedName :
                    (this._descriptorStoreAHU.MotorControl.MotorControlType.uiDescription(this.model.motorControlType) ?
                        this._descriptorStoreAHU.MotorControl.MotorControlType.uiDescription(this.model.motorControlType) : "Motor Control"),
                "#f3b629",
                "white",
                this.model.geometry.xLength,
                this.model.geometry.zLength);
    ...
    click(evt: Event) {
        ...
        if (this.isSelected) {
            CMotorControl_Selected.addToList(this.model, this);
            CMotorControl_Selected.setselectedItem(this.model.id, this.isSelected);
