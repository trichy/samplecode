...
export class CListProvider_E_DuctType implements PG.Types.IListProvider {
    ...
    public Init(): void {
        if (CListProvider_E_DuctType._LIST === null) {
            CListProvider_E_DuctType._LIST = [];
            ...
            this._storeAHU.Opening.DuctType.list().forEach(
                i => CListProvider_E_DuctType._LIST.push(
                    new PG.Types.CListItem(i.uiDescription, i.enum)));    
        }

        this.List = CListProvider_E_DuctType._LIST;
    }
