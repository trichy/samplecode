...
export class CListProvider_E_AirType implements PG.Types.IListProvider {
    ...
    public Init(): void {
        if (CListProvider_E_AirType._LIST === null) {
            CListProvider_E_AirType._LIST = [];
            ...
            this._storeAHU.Common.AirType.list().forEach(
                i => CListProvider_E_AirType._LIST.push(
                    new PG.Types.CListItem(i.uiDescription, i.enum)));    
        }

        this.List = CListProvider_E_AirType._LIST;
    }
